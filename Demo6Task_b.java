public class Demo6Task_b {
    public static void main(String[] args) {
        ...
        System.out.printf("\033[33m-".repeat(10),COLOUR2);
        System.out.printf("%s+",COLOUR2);
        System.out.printf("\033[33m-".repeat(5),COLOUR2);
        System.out.printf("%s+ \n",COLOUR2);
        System.out.printf("|%4$s%3$s%-10s%4$s%5$s|%4$s%3$s%5s%4$s%5$s|%4$s \n"," NAME","AGE ",COLOUR1,RESET,COLOUR2);
        System.out.printf("%s+",COLOUR2);
        System.out.printf("\033[33m-".repeat(10),COLOUR2);
        System.out.printf("%s+",COLOUR2);
        System.out.printf("\033[33m-".repeat(5),COLOUR2);
        System.out.printf("%s+ \n",COLOUR2);
        System.out.printf("%4$s| %3$s%-9s%4$s|%3$s%5$s%4s%3$s%4$s |%3$s \n",name1,marks1,RESET,COLOUR2,COLOUR3);
